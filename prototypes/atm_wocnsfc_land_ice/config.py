...
class BaseAtmOcnSfcLandIceTrainer(FVCoupledEmulator):
    ...
    delta_t_data = "6h"         # time step of the data. Because the ocn dataset is in 6 hours, we cannot make
                                # use of the 3hr time stepping in the atm dataset
...
tree_util.register_pytree_node(
    BaseAtmOcnSfcLandIceTrainer,
    BaseAtmOcnSfcLandIceTrainer._tree_flatten,
    BaseAtmOcnSfcLandIceTrainer._tree_unflatten
)
