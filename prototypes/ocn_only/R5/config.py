...
class OcnTrainer(BaseOcnTrainer):
    ...
    norm_urls = {}
    norm_urls["atm"] = {
        "mean": f"/global/homes/n/nagarwal/graph-ufs/prototypes/ocn_only/statistics/24h/atm.fvstatistics.1993-2019/mean_by_level.zarr",
        "std": f"/global/homes/n/nagarwal/graph-ufs/prototypes/ocn_only/statistics/24h/atm.fvstatistics.1993-2019/stddev_by_level.zarr",
        "stddiff": f"/global/homes/n/nagarwal/graph-ufs/prototypes/ocn_only/statistics/24h/atm.fvstatistics.1993-2019/diffs_stddev_by_level.zarr",
    }
    norm_urls["ocn"] = {
        "mean": f"/global/homes/n/nagarwal/graph-ufs/prototypes/ocn_only/statistics/24h/ocn.fvstatistics.1993-2019/mean_by_level.zarr",
        "std": f"/global/homes/n/nagarwal/graph-ufs/prototypes/ocn_only/statistics/24h/ocn.fvstatistics.1993-2019/stddev_by_level.zarr",
        "stddiff": f"/global/homes/n/nagarwal/graph-ufs/prototypes/ocn_only/statistics/24h/ocn.fvstatistics.1993-2019/diffs_stddev_by_level.zarr",
    }
    norm_urls["ice"] = {
        "mean": "",
        "std": "",
    ...
    # time related
    delta_t_model = "24h"        # the model time step
    delta_t_data = "6h"         # time steps in the data
    input_duration = "24h"      # time covered by initial condition(s) + delta_t (necessary for GraphCast code)
    target_lead_time = "24h"     # how long is the forecast ... at what point do we compare model to targets
    ...
    noise_std_as_fraction = 0.1
    gauss_noise_seed = 100
