...
def submit_slurm_job(config, prototype):
    ...
    the_code = \
        ...
        f"store_batch_of_samples('testing', '{prototype}')\n"
    ...
    fname = f"{script_dir}/submit_stacked_preprocess_testing.sh"
...
def store_batch_of_samples(mode, prototype):
    ...
    # Load config and initialize the emulator/global/homes/n/nagarwal/graph-ufs/prototypes/ocn_only
