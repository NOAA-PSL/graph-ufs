...
def main(varname, comp="atm"):
    ...
    gcs_path_out = os.path.dirname(Emulator.norm_urls[comp]["mean"])
    ...
    if comp in ["atm", "ice", "land"]:
        ...
        time_skip = 2 # everything is in 3 hour time steps at this resolution for atm
        ...
        time_skip = 1 # time step is 6 hour for this ocean resolution
    else:
    ...
    # check whether the zarr store exists
    try:
