...
level_variables="temperature,specific_humidity,u_component_of_wind,v_component_of_wind,vertical_velocity,layer_thickness"
all_variables="${surface_variables},total_precipitation_3hr,${level_variables}"
...
python weatherbench2/scripts/evaluate.py \
  ...
  --rename_variables=${rename_variables} \
  --levels=998.7807,847.7832,505.65207,243.94986,97.823265,47.810493
